...
public class WechatWeProgramUtil {
    ...
    public static String URL_CODE_TO_SESSION = String.format(WECHAT_API_URL_BASE + "/sns/jscode2session?grant_type=authorization_code&appid=%s&secret=%s&js_code=", WECHAT_WEPROGRAM_APP_ID, WECHAT_WEPROGRAM_APP_SECRET);
    /**
     * 　code 转化为sessionKey
     *
     * @param code
